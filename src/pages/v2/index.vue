    ...
    >
      <div class="header-inner">
        ...
        <div class="header-controls">
          <button class="btn-v1" @click="router.push('/')">← v1</button>
        ...
        >
          <div class="confirm-dialog">
            ...
            <p class="confirm-body">
              <strong>{{ deleteTarget.title }}</strong> will be permanently removed and cannot be recovered.
            </p>
...
.btn-v1:hover { background: rgba(255,255,255,0.18); }
...
.btn-new-task:hover { background: #EEF2FF; color: #3730A3; }
...
@media (max-width: 768px) {
  ...
  .btn-v1 { display: none; }
  .confirm-dialog { width: calc(100vw - 32px); padding: var(--sp-4); }
}
</style>
